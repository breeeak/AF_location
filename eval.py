...
if __name__ == '__main__':
    ...
    model_path = "D:\\3_Research\\1_Project\\1_Python\\checkpoint\\model_best.pth.tar"
    min_interval = 5
    mid_peak_inter = 2  # 中间
    features = 2
    test_batch_size = 64
    ...
    for record_name in record_list:
        ...
        print("record_name{},sumlocations{},lenlocations{},pred_dict{}".format(record_name,sum(locations),len(locations),pred_dict))
